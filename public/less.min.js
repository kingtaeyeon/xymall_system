...
!function (a) {
    ...
    return function a(b, c, d) {
        ...
        13: [function (a, b, c) {
            ...
            f.Eval = function (a, b) {
                h(a, this, j), "string" == typeof this.paths && (this.paths = [this.paths]), this.frames = b || [], this.importantScope = this.importantScope || []
        ...
        19: [function (a, b, c) {
            ...
            f.prototype.evalPlugin = function (a, b, c, f, g) {
                ...
                if (d && !a.setOptions) return new e({message: "Options have been provided but the plugin " + c + " does not support any options."});
                try {
                ...
                return a ? ("function" == typeof a && (a = new a), a.minVersion && this.compareVersion(a.minVersion, this.less.version) < 0 ? new e({message: "Plugin " + c + " requires version " + this.versionToString(a.minVersion)}) : a) : null
            ...
            b.exports = function (b) {
                ...
                f.add("data-uri", function (a, f) {
                    ...
                    var i = a && a.value, j = f.value, k = this.currentFileInfo,
                        l = k.rewriteUrls ? k.currentDirectory : k.entryPath, m = j.indexOf("#"), n = "";
        ...
        29: [function (a, b, c) {
            var d = a("../tree/dimension"), e = a("../tree/declaration"), f = a("../tree/ruleset"),
                g = a("../tree/selector"), h = a("../tree/element"), i = a("./function-registry"), j = function (a) {
            ...
            b.exports = function (a) {
                ...
                return b.prototype.push = function (b, c, i, j, k) {
                    ...
                    var n = function (a, c, d) {
                        ...
                        j.optional && a ? (k(null, {rules: []}, !1, null), h.info("The file " + d + " was skipped because it was not found and the import was marked optional.")) : (l.files[d] || j.inline || (l.files[d] = {
                            root: c,
                            options: j
        ...
        43: [function (a, b, c) {
            ...
            b.exports = function () {
                ...
                return k.save = function () {
                    ...
                    var d, e = "", f = null, g = !1, h = 0, i = [], j = [], l = b.length, m = k.i, n = k.i, o = k.i,
                        p = !0;
                    ...
                    do {
                        var q, r = b.charAt(o);
                        if (0 === h && d(r)) f = b.substr(n, o - n), j.push(f ? f : " "), f = j, a(o - m), p = !1; else {
                            if (g) {
                        ...
                        parserInput: q, imports: b, fileInfo: c, parseNode: o, parse: function (g, h, j) {
                            ...
                            primary: function () {
                                for (var a, b = this.mixin, c = []; ;) {
                                    ...
                                    if (q.finished) break;
                                    if (q.peek("}")) break;
                                    if (a = this.extendRule()) c = c.concat(a); else if (a = b.definition() || this.declaration() || this.ruleset() || b.call(!1, !1) || this.variableCall() || this.entities.call() || this.atrule()) c.push(a); else {
                                ...
                                mixinLookup: function () {
                                    ...
                                    var b, d = q.i, f = !1;
                                    if (q.save(), q.$char("~")) f = !0; else if (a) return void q.restore();
                                ...
                                var a, b, d, f = q.i;
                                if (b = this.combinator(), a = q.$re(/^(?:\d+\.\d+|\d+)%/) || q.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || q.$char("*") || q.$char("&") || this.attribute() || q.$re(/^\([^&()@]+\)/) || q.$re(/^[\.#:](?=@)/) || this.entities.variableCurly(),
                                a || (q.save(), q.$char("(") ? (d = this.selector(!1)) && q.$char(")") ? (a = new e.Paren(d), q.forget()) : q.restore("Missing closing ')'") : q.forget()), a) return new e.Element(b, a, a instanceof e.Variable, f, c)
                            }, combinator: function () {
                                var a = q.currentChar();
                                if ("/" === a) {
                                    q.save();
                                ...
                                if (!b()) {
                                    ...
                                    if (q.save(), h = q.$parseUntil(i)) {
                                        ...
                                        var m;
                                        for (d = 0; d < h.length; d++) if (m = h[d], Array.isArray(m)) l.push(new e.Quoted(m[0], m[1], (!0), k, c)); else {
        ...
        55: [function (a, b, c) {
            ...
            h.prototype = new f, h.prototype.type = "Color", h.prototype.luma = function () {
                ...
                if (e = this.fround(a, this.alpha), this.value) if (0 === this.value.indexOf("rgb")) e < 1 && (f = "rgba"); else {
        ...
        60: [function (a, b, c) {
            ...
            var e = a("./node"), f = a("./value"), g = a("./keyword"), h = a("./anonymous"), i = a("../constants").Math,
        ...
        62: [function (a, b, c) {
            ...
            h.prototype = new d, h.prototype.type = "Dimension", h.prototype.accept = function (a) {
                ...
                if ("+" === b || "-" === b) if (0 === e.numerator.length && 0 === e.denominator.length) e = c.unit.clone(),
                this.unit.backupUnit && (e.backupUnit = this.unit.backupUnit); else if (0 === c.unit.numerator.length && 0 === e.denominator.length) ; else {
        ...
        64: [function (a, b, c) {
            var d = a("./node"), e = a("./paren"), f = a("./comment"), g = a("./dimension"), h = a("../constants").Math,
                i = function (a, b) {
        ...
        72: [function (a, b, c) {
            ...
            h.prototype = new d, h.prototype.type = "MixinCall", h.prototype.accept = function (a) {
                ...
                var c, d, e, h, i, j, k, l, m, n, o, p, q, r, s, t = [], u = [], v = !1, w = [], x = [], y = -1, z = 0,
                    A = 1, B = 2;
                for (this.selector = this.selector.eval(a), j = 0; j < this.arguments.length; j++) if (h = this.arguments[j], i = h.value.eval(a), h.expand && Array.isArray(i.value)) for (i = i.value, k = 0; k < i.length; k++) t.push({value: i[k]}); else t.push({
                    name: h.name,
                    value: i
                });
                for (s = function (b) {
        ...
        73: [function (a, b, c) {
            var d = a("./selector"), e = a("./element"), f = a("./ruleset"), g = a("./declaration"),
                h = a("./detached-ruleset"), i = a("./expression"), j = a("../contexts"), k = a("../utils"),
            ...
            l.prototype = new f, l.prototype.type = "MixinDefinition", l.prototype.evalFirst = !0, l.prototype.accept = function (a) {
                ...
                if (b.frames && b.frames[0] && b.frames[0].functionRegistry && (s.functionRegistry = b.frames[0].functionRegistry.inherit()), b = new j.Eval(b, [s].concat(b.frames)), c) for (c = k.copyArray(c), u = c.length, m = 0; m < u; m++) if (l = c[m], p = l && l.name) {
                ...
                for (r = 0, m = 0; m < t.length; m++) if (!d[m]) {
                    if (l = c && c[r], p = t[m].name) if (t[m].variadic) {
                        ...
                        if (o = l && l.value) o = Array.isArray(o) ? new h(new f("", o)) : o.eval(a); else {
                            if (!t[m].value) throw{
                                type: "Runtime",
                ...
                var d, e, h = [], l = this.frames ? this.frames.concat(a.frames) : a.frames,
        ...
        74: [function (a, b, c) {
            var d = a("./node"), e = a("./variable"), f = a("./ruleset"), g = a("./selector"),
            ...
            h.prototype = new d, h.prototype.type = "NamespaceValue", h.prototype.eval = function (a) {
                ...
                for (b = 0; b < this.lookups.length; b++) {
                    if (c = this.lookups[b], Array.isArray(d) && (d = new f([new g], d)), "" === c) d = d.lastDeclaration(); else if ("@" === c.charAt(0)) {
        ...
        77: [function (a, b, c) {
            var d = a("./node"), e = a("./color"), f = a("./dimension"), g = a("../constants").Math,
                h = function (a, b, c) {
            ...
            q.prototype = new d, q.prototype.type = "Ruleset", q.prototype.isRuleset = !0, q.prototype.isRulesetLike = function () {
                ...
                function l(a, b, c) {
                    ...
                    for (q = [], r = [[]], n = 0; u = c.elements[n]; n++) if ("&" !== u.value) {
                        ...
                        for (x = !0, s = [], k(q, r), o = 0; o < r.length; o++) if (t = r[o], 0 === b.length) t.length > 0 && t[0].elements.push(new j(u.combinator, "", u.isVariable, u._index, u._fileInfo)), s.push(t); else for (p = 0; p < b.length; p++) {
                            var D = f(t, b[p], u, c);
                            s.push(D)
                        }
                        r = s, q = []
        ...
        87: [function (a, b, c) {
            var d = a("./node"), e = a("./variable"), f = a("./ruleset"), g = a("./detached-ruleset"),
                h = a("../less-error"), i = function (a, b, c) {
        ...
        98: [function (a, b, c) {
            ...
            function e(a) {
                var b;
                b = h.length ? h.pop() : new f, b.task = a,
                    g(b)
            }
        ...
        100: [function (a, b, c) {
            ...
            function f(a) {
                ...
                var i = 0;
                for (b = 0; b < c; b += 4) e = k[a.charCodeAt(b)] << 18 | k[a.charCodeAt(b + 1)] << 12 | k[a.charCodeAt(b + 2)] << 6 | k[a.charCodeAt(b + 3)], g[i++] = e >> 16 & 255, g[i++] = e >> 8 & 255, g[i++] = 255 & e;
                return 2 === f ? (e = k[a.charCodeAt(b)] << 2 | k[a.charCodeAt(b + 1)] >> 4, g[i++] = 255 & e) : 1 === f && (e = k[a.charCodeAt(b)] << 10 | k[a.charCodeAt(b + 1)] << 4 | k[a.charCodeAt(b + 2)] >> 2, g[i++] = e >> 8 & 255, g[i++] = 255 & e), g
            }
            ...
            function i(a) {
                for (var b, c = a.length, d = c % 3, e = "", f = [], g = 16383, i = 0, k = c - d; i < k; i += g) f.push(h(a, i, i + g > k ? k : i + g));
        ...
        101: [function (a, b, c) {
            ...
            function k(a, b) {
                if ("string" == typeof b && "" !== b || (b = "utf8"), !f.isEncoding(b)) throw new TypeError('"encoding" must be a valid string encoding');
                var c = 0 | q(a, b), d = e(c), g = d.write(a, b);
            ...
            function m(a, b, c) {
                ...
                var d;
                return d = void 0 === b && void 0 === c ? new Uint8Array(a) : void 0 === c ? new Uint8Array(a, b) : new Uint8Array(a, b, c), d.__proto__ = f.prototype, d
            }

            function n(a) {
                if (f.isBuffer(a)) {
                    var b = 0 | o(a.length), c = e(b);
            ...
            function o(a) {
                if (a >= Z) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + Z.toString(16) + " bytes");
                return 0 | a
            }
            ...
            function t(a, b, c, d, e) {
                ...
                if ("string" == typeof c ? (d = c, c = 0) : c > 2147483647 ? c = 2147483647 : c < -2147483648 && (c = -2147483648), c = +c, W(c) && (c = e ? 0 : a.length - 1), c < 0 && (c = a.length + c), c >= a.length) {
                    if (e) return -1;
                    c = a.length - 1
                } else if (c < 0) {
                    if (!e) return -1;
                ...
                if ("string" == typeof b && (b = f.from(b, d)), f.isBuffer(b)) return 0 === b.length ? -1 : u(a, b, c, d, e);
                if ("number" == typeof b) return b = 255 & b, "function" == typeof Uint8Array.prototype.indexOf ? e ? Uint8Array.prototype.indexOf.call(a, b, c) : Uint8Array.prototype.lastIndexOf.call(a, b, c) : u(a, [b], c, d, e);
            ...
            function L(a, b, c, d, e) {
                return b = +b, c >>>= 0, e || K(a, b, c, 4, 3.4028234663852886e38, -3.4028234663852886e38), Y.write(a, b, c, d, 23, 4), c + 4
            }

            function M(a, b, c, d, e) {
                return b = +b, c >>>= 0, e || K(a, b, c, 8, 1.7976931348623157e308, -1.7976931348623157e308), Y.write(a, b, c, d, 52, 8), c + 8
            }
            ...
            var X = a("base64-js"), Y = a("ieee754");
            c.Buffer = f, c.SlowBuffer = p, c.INSPECT_MAX_BYTES = 50;
            var Z = 2147483647;
            c.kMaxLength = Z, f.TYPED_ARRAY_SUPPORT = d(), f.TYPED_ARRAY_SUPPORT || "undefined" == typeof console || "function" != typeof console.error || console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."), "undefined" != typeof Symbol && Symbol.species && f[Symbol.species] === f && Object.defineProperty(f, Symbol.species, {
                value: null,
                configurable: !0,
                enumerable: !1,
                writable: !1
            }), f.poolSize = 8192, f.from = function (a, b, c) {
                return g(a, b, c)
                ...
                if (a === b) return 0;
                for (var c = a.length, d = b.length, e = 0, g = Math.min(c, d); e < g; ++e) if (a[e] !== b[e]) {
                    c = a[e], d = b[e];
                    break
                }
            ...
            f.prototype.slice = function (a, b) {
                ...
                var e, f = d - c;
                if (this === a && c < b && b < d) for (e = f - 1; e >= 0; --e) a[e + b] = this[e + c]; else if (f < 1e3) for (e = 0; e < f; ++e) a[e + b] = this[e + c]; else Uint8Array.prototype.set.call(a, this.subarray(c, c + f), b);
                return f
                ...
                var g;
                if ("number" == typeof a) for (g = b; g < c; ++g) this[g] = a; else {
                    var h = f.isBuffer(a) ? a : new f(a, d), i = h.length;
                ...
                var c = function () {
                    ...
                    function c(d, e, f, g, j) {
                        function m(d, f) {
                            ...
                            if (b(d, i)) q = new i; else if (b(d, k)) q = new k; else if (b(d, l)) q = new l(function (a, b) {
                                d.then(function (b) {
                                    a(m(b, f - 1))
                                }, function (a) {
                                    b(m(a, f - 1))
                                })
                            }); else if (c.__isArray(d)) q = []; else if (c.__isRegExp(d)) q = new RegExp(d.source, h(d)), d.lastIndex && (q.lastIndex = d.lastIndex); else if (c.__isDate(d)) q = new Date(d.getTime()); else {
                                if (p && a.isBuffer(d)) return q = a.allocUnsafe ? a.allocUnsafe(d.length) : new a(d.length), d.copy(q), q;
                                b(d, Error) ? q = Object.create(d) : "undefined" == typeof g ? (r = Object.getPrototypeOf(d), q = Object.create(r)) : (q = Object.create(g), r = g)
                            }
                            if (e) {
                                var s = n.indexOf(d);
                                if (s != -1) return o[s];
                            ...
                            b(d, i) && d.forEach(function (a, b) {
                                var c = m(b, f - 1), d = m(a, f - 1);
                                q.set(c, d)
                            }), b(d, k) && d.forEach(function (a) {
                                var b = m(a, f - 1);
                                q.add(b)
                            });
                            for (var t in d) {
                            ...
                            if (Object.getOwnPropertySymbols) for (var v = Object.getOwnPropertySymbols(d), t = 0; t < v.length; t++) {
                                var w = v[t], x = Object.getOwnPropertyDescriptor(d, w);
                                (!x || x.enumerable || j) && (q[w] = m(d[w], f - 1), x.enumerable || Object.defineProperty(q, w, {enumerable: !1}))
                            }
                            if (j) for (var y = Object.getOwnPropertyNames(d), t = 0; t < y.length; t++) {
                                var z = y[t], x = Object.getOwnPropertyDescriptor(d, z);
                                x && x.enumerable || (q[z] = m(d[z], f - 1), Object.defineProperty(q, z, {enumerable: !1}))
                            }
                            return q
                        }

                        "object" == typeof e && (f = e.depth, g = e.prototype, j = e.includeNonEnumerable, e = e.circular);
                        var n = [], o = [], p = "undefined" != typeof a;
                    ...
                    return c.clonePrototype = function (a) {
                        if (null === a) return null;
                        var b = function () {
                        };
                        return b.prototype = a, new b
                    }, c.__objToStr = d, c.__isDate = e, c.__isArray = f, c.__isRegExp = g, c.__getRegExpFlags = h, c
                }();
